...
- Get your [Necessary Variables](https://github.com/pyaesone-5-usm/AnonXMusic/blob/master/sample.env)
...
`git clone https://github.com/pyaesone-5-usm/AnonXMusic && cd AnonXMusic`
